...
export default async function Home() {
  ...
  return (
    <div className="container mx-auto p-4 flex gap-8 min-h-screen max-w-screen-xl flex-col lg:flex-row">
      <div className="w-full flex flex-col justify-center text-center lg:text-left gap-2 py-8">
        <h2 className="text-3xl">Welcome to</h2>
        <h1 className="text-5xl lg:text-6xl">The Trivia Game App</h1>
        <p className="text-lg mt-4">Answer 10 questions and let&apos;s see how many you get it right!</p>
      </div>
